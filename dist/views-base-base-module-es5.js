(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-base-base-module"], {
          ...
          value: function show() {
            ...
            */
            function showPopover() {
              ...
              _this2._popover.attach(PopoverContainerComponent).to(_this2.container).position({
                attachment: _this2.placement
              }).show({
                content: _this2.popover,
                context: _this2.popoverContext,
                placement: _this2.placement,
                title: _this2.popoverTitle,
                containerClass: _this2.containerClass
              });

              if (!_this2.adaptivePosition) {
                _this2._positionService.calcPosition();

                _this2._positionService.deletePositionElement(_this2._popover._componentRef.location);
              }
            ...
            */
            function cancelDelayedTooltipShowing() {
              if (_this2._popoverCancelShowFn) {
                _this2._popoverCancelShowFn();
              }
            };
            ...
            if (this.delay) {
              ...
              */
              ...
              if (this.triggers) {
                ...
                */
                function (trigger) {
                  _this2._popoverCancelShowFn = _this2._renderer.listen(_this2._elementRef.nativeElement, trigger.close,
                  /**
                  * @return {?}
                  */
                  function () {
    ...
    /***/
    function LYaK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var CarouselComponent = /*#__PURE__*/function () {
        ...
        _createClass(CarouselComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            */
            function () {
              if (_this4.singleSlideOffset) {
                _this4.indicatorsByChunk = false;
              }

              if (_this4.multilist) {
                _this4._chunkedSlides = chunkByNumber(_this4.mapSlidesAndIndexes(), _this4.itemsPerSlide);

                _this4.selectInitialSlides();
              }
            }, 0);
          }
          /**
            ...
            if (this._currentActiveSlide === remIndex) {
              ...
              */
              function () {
                ...
                _this5._currentActiveSlide = currentSlideIndex;

                _this5.activeSlideChange.emit(_this5._currentActiveSlide);
              }, 0);
            }
          }
          /**
          ...
          value: function indicatorsSlides() {
            ...
            */
            function (slide, index) {
              return !_this6.indicatorsByChunk || index % _this6.itemsPerSlide === 0;
            });
          }
          /**
           * @private
              ...
              function () {
                ...
                */
                function () {
                  ...
                  */
                  function () {
                    if (_this7.isPlaying && !isNaN(_this7.interval) && nInterval > 0 && _this7.slides.length) {
                      _this7.nextSlideFromInterval();
                    } else {
                      _this7.pause();
                    }
                  });
    ...
    /***/
    function Mfq2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
          ...
          value: function show() {
            ...
            */
            function showTooltip() {
              ...
              _this9._tooltip.attach(TooltipContainerComponent).to(_this9.container).position({
                attachment: _this9.placement
              }).show({
                content: _this9.tooltip,
                placement: _this9.placement,
                containerClass: _this9.containerClass,
                id: "tooltip-".concat(_this9.tooltipId)
              });
            };
            /** @type {?} */
            ...
            */
            function cancelDelayedTooltipShowing() {
              if (_this9._tooltipCancelShowFn) {
                _this9._tooltipCancelShowFn();
              }
            };
            ...
            if (this.delay) {
              ...
              */
              ...
              if (this.triggers) {
                ...
                */
                function (trigger) {
                  _this9._tooltipCancelShowFn = _this9._renderer.listen(_this9._elementRef.nativeElement, trigger.close,
                  /**
                  * @return {?}
                  */
                  function () {
                    _this9._delaySubscription.unsubscribe();
    ...
    /***/
    function yyhP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
