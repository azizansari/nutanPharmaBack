        ...
        _createClass(OrdersComponent, [{
          ...
          value: function toGetPrint(id) {
            this.router.navigate([]).then(function (result) {
              window.open("#/orders/".concat(id), "_blank");
            });
          }
        }, {
          key: "formValues",
